"""
This script goes through the original dataset, and processes each image using our preprocessing pipeline. The warped
images are placed into the warped_dataset. This script requires manual intervention from the user to filter out
images that have very poor quality after warping.
"""
import cv2
import re
import os
...
import threading
from python_scripts.python_helper_functions import detectSudokuPuzzle
